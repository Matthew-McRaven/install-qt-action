...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            switch (process.platform) {
                case "win32": {
                    yield exec.exec(`${pythonName} -m aqt tool windows tools_ifw 3.1.1 qt.tools.ifw.31`);
                    yield exec.exec(`${pythonName} -m aqt tool windows tools_vcredist 2019-02-13-1 qt.tools.vcredist_msvc2017_x64`);
                }
                case "darwin": {
                    yield exec.exec(`${pythonName} -m aqt tool mac tools_ifw 3.1.1 qt.tools.ifw.31`);
                }
                default: {
                    yield exec.exec(`${pythonName} -m aqt tool linux tools_ifw 3.1.1 qt.tools.ifw.31`);
                }
            }
